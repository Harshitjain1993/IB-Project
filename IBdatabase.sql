...
SELECT [SINO],[CONTACTPERSONNAME], [CONTACTDETAILS],[REPAIRDATE],[REMARKS],[HISTORY SHEET],[REPAIRSTATUS]
FROM tbl_ITEM_HISTORY ih JOIN tbl_REPAIR_STATUS rs on ih.REPAIRCODE=rs.REPAIRCODE 